# [full stack nginx Django for everyone with docker compose](https://github.com/damalis/full-stack-nginx-django-for-everyone-with-docker-compose)

If You want to build a website with Django "webapp" at short time;

#### Full stack Nginx Django "webapp":
<p align="left">
<a href="https://www.djangoproject.com/" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/27804?s=200&v=4" alt="Django" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
```
git clone https://github.com/damalis/full-stack-nginx-django-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-nginx-django-for-everyone-with-docker-compose
chmod +x install.sh
...
The containers are now built and running. You should be able to access the Django installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
...
[https://www.nginx.com/resources/wiki/start/topics/examples/djangofastcgi/](https://www.nginx.com/resources/wiki/start/topics/examples/djangofastcgi/)
